...
/** Tools whose results are just success/failure confirmations. */
const DISPOSABLE_RESULT_TOOLS = new Set(["Edit", "Write"]);
...
export function summarizeToolResult(resultBlock, toolInfo) {
	...
	// Bash — critical for errors and test results
	if (toolName === "Bash")
		return content ? `← ${startEndTrim(content, BASH_OUTPUT_LIMIT)}` : null;
